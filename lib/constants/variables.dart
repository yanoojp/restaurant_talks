...
// // // Item Categories
// // final List<ItemCategory> itemCategories = [
// //   ItemCategory(id: 0, value: allCategory),
// //   ItemCategory(id: 1, value: appetizerCategory),
// //   ItemCategory(id: 2, value: mainDishCategory),
// //   ItemCategory(id: 3, value: dessertCategory),
// //   ItemCategory(id: 4, value: beverageCategory),
// //   ItemCategory(id: 5, value: otherCategory),
// // ];
// // String notSelected =
// //     currentLanguage == englishLanguage ? 'Not Selected' : '選択されていません';
// // String allCategory =
// //     currentLanguage == englishLanguage ? 'All Categories' : 'すべてのカテゴリー';
// // String appetizerCategory =
// //     currentLanguage == englishLanguage ? 'Appetizers' : '前菜';
// // String mainDishCategory =
// //     currentLanguage == englishLanguage ? 'Main Dishes' : '主な料理';
// // String dessertCategory =
// //     currentLanguage == englishLanguage ? 'Desserts' : 'デザート';
// // String beverageCategory =
// //     currentLanguage == englishLanguage ? 'Beverages' : '飲み物';
// // String otherCategory = currentLanguage == englishLanguage ? 'Others' : 'その他';
