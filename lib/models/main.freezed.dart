...
/// @nodoc
mixin _$Main {
  String get helloWorld => throw _privateConstructorUsedError;
...
abstract class $MainCopyWith<$Res> {
  ...
  @useResult
  $Res call({String helloWorld, int number});
}
...
class _$_Main implements _Main {
  const _$_Main({required this.helloWorld, required this.number});
  ...
  @override
  String toString() {
    return 'Main(helloWorld: $helloWorld, number: $number)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, helloWorld, number);
...
abstract class _Main implements Main {
  const factory _Main(
      {required final String helloWorld, required final int number}) = _$_Main;
