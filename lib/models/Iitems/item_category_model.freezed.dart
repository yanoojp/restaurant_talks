...
class _$_ItemCategory implements _ItemCategory {
  const _$_ItemCategory({required this.id, required this.value});
  ...
  @override
  String toString() {
    return 'ItemCategory(id: $id, value: $value)';
  }
...
abstract class _ItemCategory implements ItemCategory {
  const factory _ItemCategory(
      {required final int id, required final String value}) = _$_ItemCategory;
