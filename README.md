...
1. There was stress due to lack of communication between the hall and the kitchen.
    ...
    + We also had to tell the kitchen how many guests are in the restaurant or how many guests are expected to come by mouth.
    + To solve this problem, I thought a system to manage inventory or guest number would be helpful.

2. More will be added when I add more features.

2. Achieving these objectives could lead to the following additional benefits:
    + Reducing waste
    + Improved guest service

## Focus During Development
+ Making it usable not only in my previous job but also in gereral in restaurants
    + I omitted features that were too specific and initially planned, focusing on simplicity.
+ Aiming to develop an app that can be used quickly and efficiently with smartphones or tablets in real-world scenarios

## Feature List For Now (Detailed usage instructions are described below.)
...
+ How it Works with food inventory management<br>
  1. When the kitchen prepares or cooks food, they register the number made.<br>
  2. When serving registered food, the server register the number he/she served.<br>
...
+ Adding a feature to place orders from the order list